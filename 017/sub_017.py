...
model.add(Flatten())
model.add(Dense(128, init = 'lecun_uniform', W_regularizer=l2(0.01), activity_regularizer=activity_l2(0.01)))
model.add(Activation('relu'))
model.add(Dropout(0.35))
...
# visualize_util.plot(model, to_file = 'base_model.png')
...
# Save model visualization.
# visualize_util.plot(model, to_file = 'base_model_without_validation.png')
